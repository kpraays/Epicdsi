...
log_path = "/people_mobility_origin_dest/weekly_data/filtered_weekly/logs"
data_path = "/people_mobility_origin_dest/weekly_data"
processed_path = "/people_mobility_origin_dest/weekly_data/filtered_weekly/processed"
...
def process_data(file_list) -> None:
...
if __name__ == "__main__":
    file_list = get_files(data_path=data_path)
    process_data(file_list=file_list)
