...
public class Features {
    ...
    private static double[] calculateSanDiegoFeatures(double[] x, double[] y, double[] z, int sampleRate) {
        ...
        */
        ...
        // get per direction metrics for median, min, max, 25thp, 75thp
        double[] paQuartilesx = AccStats.percentiles(wx, new double[] {0, 0.25, 0.5, 0.75, 1});
        double[] paQuartilesy = AccStats.percentiles(wy, new double[] {0, 0.25, 0.5, 0.75, 1});
        double[] paQuartilesz = AccStats.percentiles(wz, new double[] {0, 0.25, 0.5, 0.75, 1});
        ...
        double[] output = new double[]{
            ...
            sdStd,
            sdCoefVariation,
            paQuartilesx[2], // median x
            paQuartilesx[0], // min x
            paQuartilesx[4], // max x
            paQuartilesx[1], // 25th x
            paQuartilesx[3], // 75th x
            paQuartilesx[3]-paQuartilesx[1], //iqrx
            paQuartilesy[2], // median y
            paQuartilesy[0], // min y
            paQuartilesy[4], // max y
            paQuartilesy[1], // 25th y
            paQuartilesy[3], // 75th y
            paQuartilesy[3]-paQuartilesy[1], //iqry                      
            paQuartilesz[2], // median z
            paQuartilesz[0], // min z
            paQuartilesz[4], // max z
            paQuartilesz[1], // 25th z
            paQuartilesz[3], // 75th z
            paQuartilesz[3]-paQuartilesz[1], //iqrz
            paQuartiles[2], // median all
            paQuartiles[0], // min all
            paQuartiles[4], // max all
            paQuartiles[1], // 25th all
            paQuartiles[3], // 75th all
            autoCorrelation,
            xyCorrelation,
            xzCorrelation,
            yzCorrelation,
